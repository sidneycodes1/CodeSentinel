...
export default function ExplainPopover({ code, language, onClose, position, selectionText }: ExplainPopoverProps) {
    ...
    return (
        <div
            ref={popoverRef}
            className="absolute z-50 w-80 md:w-96 bg-white border border-slate-200 shadow-2xl rounded-xl flex flex-col transform -translate-y-full mt-[-10px] left-0 md:left-auto overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-200"
            style={{ top: position.top, left: position.left }}
        >
            <div className="bg-slate-50 px-4 py-2.5 border-b border-slate-200 flex justify-between items-center">
                <span className="text-xs font-bold text-slate-900 uppercase tracking-widest">AI Explanation</span>
            ...
            <div className="p-5 text-sm text-slate-700 max-h-80 overflow-y-auto leading-relaxed">
                {isLoading ? (
